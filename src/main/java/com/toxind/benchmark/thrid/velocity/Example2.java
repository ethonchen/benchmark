package com.toxind.benchmark.thrid.velocity;
 ...
 * be used in a standalone application using the Velocity utility class.
 * 
 * It demonstrates two of the 'helper' methods found in the
 * org.apache.velocity.util.Velocity class, mergeTemplate() and evaluate().
 * 
 * 
...
public class Example2 {
	public static void main(String args[]) {
		...
		try {
			Velocity.init("D:/MyCodes/toxind/src/main/java/com/velocity/velocity.properties");
		} catch (Exception e) {
