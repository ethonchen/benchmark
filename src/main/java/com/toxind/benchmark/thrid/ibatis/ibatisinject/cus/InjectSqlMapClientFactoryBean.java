...
public class InjectSqlMapClientFactoryBean extends SqlMapClientFactoryBean implements ApplicationContextAware{
	private SqlMapParser mapParser = null;
	
	public InjectSqlMapClientFactoryBean() {
		super();
	}
	...
	protected SqlMapClient buildSqlMapClient(Resource[] configLocations,
		...
		client = new InjectSqlMapClient(client, mapParser,configParser,configLocations);
		return client;
	}
	/**
